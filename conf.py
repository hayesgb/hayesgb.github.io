...
BLOG_AUTHOR = "Greg Hayes"  # (translatable)
BLOG_TITLE = "The Microsite of Greg Hayes"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.gregoryhayes.us/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.gregoryhayes.us/"
BLOG_EMAIL = "hayesgb@gmail.com"
BLOG_DESCRIPTION = "A site for my personal projects & musings"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://linkedin.com/gregorybhayes', 'My LinkedIn', 'fab fa-linkedin'),
        ('https://github.com/hayesgb', 'My Github', 'fab fa-github'),
    )
}
